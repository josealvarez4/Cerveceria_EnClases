...
var session = require('express-session'); // M4U4 Login autentificacion
...
var adminRouter = require('./routes/admin/novedades'); // M4U4 Login
...
app.use('/admin/novedades', secured, adminRouter); // M4U4 Login
